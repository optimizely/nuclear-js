...
/***/ function(module, exports, __webpack_require__) {
	...
	var _examplesItemFilter = __webpack_require__(1);

	var _examplesItemFilter2 = _interopRequireDefault(_examplesItemFilter);

	(0, _examplesItemFilter2['default'])(document.getElementById('ex1'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsStateViewer = __webpack_require__(160);
	...
	reactor.registerStores({
	  typeFilter: (0, _nuclearJs.Store)({
	    getInitialState: function getInitialState() {
	      return null;
	    },

	    initialize: function initialize() {
	      this.on('FILTER_TYPE', function (state, type) {
	        return type;
	      });
	    }
	  }),

	  items: (0, _nuclearJs.Store)({
	    getInitialState: function getInitialState() {
	      return (0, _nuclearJs.toImmutable)([{ type: 'food', name: 'banana', price: 1 }, { type: 'food', name: 'doritos', price: 4 }, { type: 'clothes', name: 'shirt', price: 15 }, { type: 'clothes', name: 'pants', price: 20 }]);
	    }
	  })
	});
	...
	exports['default'] = function (el) {
	  _react2['default'].render(_react2['default'].createElement(ItemFilterExample, null), el);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function formatState(state) {
	  return JSON.stringify((0, _nuclearJs.toJS)(state), null, '  ').replace(/\{([^{}]+)\}/g, function (match, contents, index, all) {
	    return match.replace(/\n\s+/g, '');
	  });
	}

	exports['default'] = _react2['default'].createClass({
	  displayName: 'state-viewer',
	  ...
	  componentWillMount: function componentWillMount() {
	    ...
	    this._unobserve = reactor.observe(stateGetter, function (appState) {
	      _this.setState({ appState: appState });
	    });

	    var appState = reactor.evaluate(stateGetter);
