...
describe('reactor fns', () => {
  ...
  describe('#removeObserverByEntry', () => {
    ...
    it('should should not clear cache if there is only one entry associated with a getter', () => {
      expect(initialReactorState.getIn(['cache', getter1])).toBe('test1')
      expect(initialReactorState.getIn(['cacheRecency', getter1])).toBe('test1')
    ...
    it('should should clear cache if there is more than one entry associated with a getter', () => {
      expect(initialReactorState.getIn(['cache', getter1])).toBe('test1')
      expect(initialReactorState.getIn(['cacheRecency', getter1])).toBe('test1')
      ...
      expect(reactorState2.getIn(['cache', getter1])).toBe(undefined)
      expect(reactorState2.getIn(['cacheRecency', getter1])).toBe(undefined)
    })
  })
