...
/***/ function(module, exports, __webpack_require__) {
	...
	var mockData = __webpack_require__(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	flux.registerStores({
	  currentThreadID: __webpack_require__(6),
	  threads: __webpack_require__(7) });

	module.exports = {
	  actions: __webpack_require__(8),

	  getters: __webpack_require__(9) };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageSection = __webpack_require__(11);
	var React = __webpack_require__(4);
	var ThreadSection = __webpack_require__(12);

	var ChatApp = React.createClass({ displayName: "ChatApp",

	  render: function render() {
	    return React.createElement("div", { className: "chatapp" }, React.createElement(ThreadSection, null), React.createElement(MessageSection, null));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Nuclear = __webpack_require__(38);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function setCurrentThreadID(state, _ref) {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	function addMessage(state, _ref) {
	  var message = _ref.message;

	  var msg = toImmutable(message);
	  var threadID = msg.get("threadID");

	  return state.withMutations(function (threads) {
	    ...
	    threads.update(threadID, function (thread) {
	      var sortedMessages = thread.get("messages").push(msg).sortBy(function (msg) {
	 ...
	 */
	function setMessagesRead(state, _ref) {
	  var threadID = _ref.threadID;

	  return state.updateIn([threadID, "messages"], function (messages) {
	    return messages.map(function (msg) {
	      return msg.set("isRead", true);
	    });
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var flux = __webpack_require__(5);
	var actionTypes = __webpack_require__(13);
	var getters = __webpack_require__(9);
	...
	exports.receiveAll = function (messages) {
	  messages.forEach(function (message) {
	    flux.dispatch(actionTypes.ADD_MESSAGE, { message: message });
	  });
	};
	...
	exports.createMessage = function (text, threadID) {
	  ...
	  var id = "m_" + timestamp;
	  var threadName = flux.evaluate([getters.threadsMap, function (threadsMap) {
	    return threadsMap.getIn([threadID, "threadName"]);
	  }]);
	  var authorName = "Jordan";

	  flux.dispatch(actionTypes.ADD_MESSAGE, {
	    message: { id: id, threadID: threadID, threadName: threadName, authorName: authorName, timestamp: timestamp, text: text }
	  });
	};

	exports.clickThread = function (threadID) {
	  flux.dispatch(actionTypes.CLICK_THREAD, { threadID: threadID });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.threads = [exports.threadsMap, function (threadsMap) {
	  return threadsMap.toList();
	}];

	exports.currentThread = [["currentThreadID"], exports.threadsMap, function (currentThreadID, threadsMap) {
	  return threadsMap.get(currentThreadID);
	}];

	exports.latestThread = [exports.threads, function (threads) {
	  return threads.sortBy(function (thread) {
	    thread.get("messages").last().get("timestamp");
	  }).last();
	}];

	exports.currentThreadID = [exports.currentThread, function (thread) {
	  return thread ? thread.get("threadID") : null;
	}];

	exports.unreadCount = [exports.threads, function (threads) {
	  return threads.reduce(function (accum, thread) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageComposer = __webpack_require__(161);
	var MessageListItem = __webpack_require__(162);
	var Message = __webpack_require__(2);
	var flux = __webpack_require__(5);
	var React = __webpack_require__(4);
	...
	var MessageSection = React.createClass({ displayName: "MessageSection",
	  ...
	  render: function render() {
	    ...
	    var messageListItems = this.state.thread.get("messages").map(function (message) {
	      return React.createElement(MessageListItem, {
	        key: message.get("id"),
	        message: message });
	    });

	    return React.createElement("div", { className: "message-section" }, React.createElement("h3", { className: "message-thread-heading" }, thread.get("threadName")), React.createElement("ul", { className: "message-list", ref: "messageList" }, messageListItems), React.createElement(MessageComposer, { threadID: thread.get("threadID") }));
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ThreadListItem = __webpack_require__(163);
	  ...
	  render: function render() {
	    ...
	    var threadListItems = this.state.threads.map(function (thread) {
	      return React.createElement(ThreadListItem, {
	        ...
	        thread: thread,
	        currentThreadID: _this.state.currentThreadID });
	    }, this);
	    var unread = this.state.unreadCount === 0 ? null : React.createElement("span", null, "Unread threads: ", this.state.unreadCount);
	    return React.createElement("div", { className: "thread-section" }, React.createElement("div", { className: "thread-count" }, unread), React.createElement("ul", { className: "thread-list" }, threadListItems));
	  } });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactLifeCycle = __webpack_require__(178);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageListItem = React.createClass({ displayName: "MessageListItem",
	  ...
	  render: function render() {
	    ...
	    return React.createElement("li", { className: "message-list-item" }, React.createElement("h5", { className: "message-author-name" }, message.get("authorName")), React.createElement("div", { className: "message-time" }, dateString), React.createElement("div", { className: "message-text" }, message.get("text")));
	  }
	...
	var ThreadListItem = React.createClass({ displayName: "ThreadListItem",
	  ...
	  render: function render() {
	    ...
	    return React.createElement("li", {
	      ...
	      onClick: this._onClick }, React.createElement("h5", { className: "thread-name" }, thread.get("threadName")), React.createElement("div", { className: "thread-time" }, dateString), React.createElement("div", { className: "thread-last-message" }, lastMessage.get("text")));
	  },
