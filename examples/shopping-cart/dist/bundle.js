...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactor = __webpack_require__(1);
	...
	var _storesCartStore = __webpack_require__(3);

	var _storesCartStore2 = _interopRequireDefault(_storesCartStore);

	var _storesProductStore = __webpack_require__(8);
	...
	_reactor2['default'].registerStores({
	  ...
	  products: _storesProductStore2['default']
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = (0, _nuclearJs.Store)({
	  ...
	  initialize: function initialize() {
	    this.on(_actionTypes.CHECKOUT_START, beginCheckout);
	    this.on(_actionTypes.CHECKOUT_SUCCESS, finishCheckout);
	    this.on(_actionTypes.CHECKOUT_FAILED, rollback);
	...
	function addToCart(state, _ref) {
	  ...
	  return state.hasIn(['itemQty', product.id]) ? state.updateIn(['itemQty', product.id], function (quantity) {
	    return quantity + 1;
	  }) : state.setIn(['itemQty', product.id], 1);
	}

	function beginCheckout(state) {
	  var currentItems = state.get('itemQty');

	  return state.set('itemQty', (0, _nuclearJs.toImmutable)({})).set('pendingCheckout', currentItems);
	}
	...
	function rollback(state) {
	  return state.set('itemQty', state.get('pendingCheckout')).set('pendingCheckout', (0, _nuclearJs.toImmutable)({}));
	}
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commonApiShop = __webpack_require__(10);

	var _commonApiShop2 = _interopRequireDefault(_commonApiShop);
	...
	exports['default'] = {
	  fetchProducts: function fetchProducts() {
	    _commonApiShop2['default'].getProducts(function (products) {
	  ...
	  cartCheckout: function cartCheckout() {
	    ...
	    _commonApiShop2['default'].buyProducts(productsInCart, function () {
...
/***/ function(module, exports) {
	...
	var cartProducts = [['products'], ['cart', 'itemQty'], function (products, itemQty) {
	  return itemQty.map(function (quantity, productId) {
	    var product = products.get(productId);
	    return product.set('quantity', quantity).remove('inventory') // inventory shouldnt be known in cart
	    ;
	  }).toList();
	}];

	var cartTotal = [cartProducts, function (items) {
	...
	exports['default'] = { products: products, cartProducts: cartProducts, cartTotal: cartTotal };
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CartContainer = __webpack_require__(167);

	var _CartContainer2 = _interopRequireDefault(_CartContainer);

	var _ProductsContainer = __webpack_require__(169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commonComponentsCart = __webpack_require__(168);

	var _commonComponentsCart2 = _interopRequireDefault(_commonComponentsCart);
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  getDataBindings: function getDataBindings() {
	    return {
	      products: _getters2['default'].cartProducts,
	      total: _getters2['default'].cartTotal
	    };
	  },
	  ...
	  onCheckoutClicked: function onCheckoutClicked() {
	    ...
	    _actions2['default'].cartCheckout();
	  },

	  render: function render() {
	    return _react2['default'].createElement(_commonComponentsCart2['default'], { products: this.state.products.toJS(), total: this.state.total, onCheckoutClicked: this.onCheckoutClicked });
	  }
	});
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commonComponentsProductItem = __webpack_require__(170);

	var _commonComponentsProductItem2 = _interopRequireDefault(_commonComponentsProductItem);

	var _commonComponentsProductsList = __webpack_require__(171);

	var _commonComponentsProductsList2 = _interopRequireDefault(_commonComponentsProductsList);
	...
	var ProductItemContainer = _react2['default'].createClass({
	  displayName: 'ProductItemContainer',

	  onAddToCartClicked: function onAddToCartClicked() {
	    _actions2['default'].addToCart(this.props.product);
	  },

	  render: function render() {
	    return _react2['default'].createElement(_commonComponentsProductItem2['default'], { product: this.props.product, onAddToCartClicked: this.onAddToCartClicked });
	  }
	});
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  getDataBindings: function getDataBindings() {
	    return {
	      products: _getters2['default'].products
	    };
	  },

	  render: function render() {
	    return _react2['default'].createElement(
	      _commonComponentsProductsList2['default'],
	      { title: 'Flux Shop Demo (NuclearJS)' },
	      this.state.products.map(function (product) {
	        return _react2['default'].createElement(ProductItemContainer, { key: product.get('id'), product: product.toJS() });
	      }).toList()
	    );
	  }
	});
